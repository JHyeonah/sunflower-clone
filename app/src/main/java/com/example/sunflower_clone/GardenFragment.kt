...
import com.example.sunflower_clone.adapters.GardenPlantingAdapter
import com.example.sunflower_clone.adapters.PLANT_LIST_PAGE_INDEX
import com.example.sunflower_clone.databinding.FragmentGardenBinding
import com.example.sunflower_clone.viewmodels.GardenPlantingListViewModel
...
class GardenFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding.addPlant.setOnClickListener { navigateToPlantListPage() }
