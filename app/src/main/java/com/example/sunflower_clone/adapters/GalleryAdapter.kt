...
import com.example.sunflower_clone.data.UnsplashPhoto
import com.example.sunflower_clone.databinding.ListItemPhotoBinding

class GalleryAdapter : PagingDataAdapter<UnsplashPhoto, GalleryAdapter.GalleryViewHolder>(GalleryDiffCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GalleryViewHolder {
        return GalleryViewHolder(ListItemPhotoBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
        ...
        init {
            binding.setClickListener { view ->
                binding.photo?.let { photo ->
                    Log.d("debug", "username :" + photo.user.username)
